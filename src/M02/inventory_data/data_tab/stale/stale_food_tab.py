...
class StaleFoodTab(QWidget):
    currentCategory = "All Categories"
    def __init__ (self):
        super(StaleFoodTab, self).__init__()
        ...
        self.data = im.getStaleFoodData(None)
    ...
    def changeCategory(self, category):
        ...
        if category == "All Categories":
          ...
          self.data = im.getStaleFoodData(category)
    ...
    def changeSearch(self):
        ...
        if (category == "All Categories"):
            temp = im.getStaleFoodData(None)
        else:
            temp = im.getStaleFoodData(category)
        self.data = []
        for i in temp:
            if (content in i[0]):
                self.data.append(i)
