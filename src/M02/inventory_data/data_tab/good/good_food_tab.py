...
class GoodFoodTab(QWidget):
    currentCategory = "All Categories"
    def __init__ (self):
        super(GoodFoodTab, self).__init__()
        ...
        self.data = im.getGoodFoodData(None)
    ...
    def changeCategory(self, category):
        ...
        if category == "All Categories":
          ...
          self.data = im.getGoodFoodData(category)
    ...
    def changeSearch(self):
        ...
        if (category == "All Categories"):
            temp = im.getGoodFoodData(None)
        else:
            temp = im.getGoodFoodData(category)
        self.data = []
        for i in temp:
            if (content in i[0]):
                self.data.append(i)
